		...
		<div class="container">
			<div class="row">
				...
				<div style="margin-top: -50px;" class="col-sm-12 col-md-12 col-lg-12 col-xl-8">
					<form class="form-block form-h-55 form-plr-20 form-bg-white text-center" action="{{ url('/contact') }} " method="post">
						@csrf
						<div class="row">
							<div class="col-sm-6 mb-30">
								<input style="border: solid 1px #000;" type="text" placeholder="Name" name="name">
							</div><!-- col-sm-6-->	
							
							<div class="col-sm-6 mb-30">
								<input style="border: solid 1px #000;" type="text" placeholder="Email" name="email">
							</div><!-- col-sm-6-->
							
							<div class="col-sm-12 mb-30">
								<textarea style="border: solid 1px #000;" class="ptb-20 min-h-200x" placeholder="Comment" name="comment"></textarea>
							</div><!-- col-sm-12-->
